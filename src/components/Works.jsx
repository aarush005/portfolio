     ...
     index * 0.5, 0.75)}>
      ...
      >
        ...
        <div className="absolute inset-0 flex justify-end m-3 card-img_hover">
          <div onClick={() => window.open (source_code_link, "https://github.com/adrianhajdin/project_3D_developer_portfolio")} className="black-gradient w-10 h-10 rounded-full flex justify-center items-center cursor-pointer ">
     ...
     <motion.div variants={textVariant()}>
          ...
          <div className="mt-20 flex flex-wrap gap-7">
            {projects.map((project,index) => (
              <ProjectsCard key={`project-${index}`}
              index={index}
              {...project}
              />
            ))}
